...
$conn = mysqli_connect('localhost:3307','root','','project') or die('connection failed');
...
<header class="header">
    ...
    <a href="#" class="logo"> <i class="fas fa-heartbeat"></i> <strong>Bone</strong>Care </a>

    <nav class="navbar">
        <a href="#home">home</a>
        <a href="viewlabresults.php">Lab Results</a>
        <a href="view.php">My History</a>
        <a href="viewradiology.php">View Xrays</a>
